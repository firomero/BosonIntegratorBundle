...
class IntegratorCache {
     ...
     * @var string
     */
    private $_cachepath = 'app/cache/integrador/';
     ...
     * @return \UCI\Boson\IntegratorBundle\Manager\IntegratorCache
     */
    ...
    /**
     * Guardia un elemento en la cache
     * @param $key
     * @param $data
     */
    ...
    /**Devuelve si existe determinada llave
     * @param $id
     * @return bool
     */
    public function contains($id)
    {
        return $this->isCached($id);
    }
